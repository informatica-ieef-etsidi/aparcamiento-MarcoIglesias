...
void buscarPlazaLibre(struct plazas plaza[]);
void buscarVehiculo(struct plazas plaza[]);
void main() {
	...
	int i = 0, j, z = 2, h, x, b, w, m, t, a = 0, numeroplazas=0;
